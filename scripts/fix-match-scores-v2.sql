-- 戦績表のスコアを本サイト（pl11.jp）と照合して修正 v2
...
-- ==================================================
-- STEP 2: 不足している試合を追加（venueを含む）
-- ==================================================

-- 大豆戸 vs 横浜: 5-0 (6/22) を追加
INSERT INTO matches (home_team_id, away_team_id, home_score, away_score, match_date, venue, status, season_id)
SELECT '7b4c8e6b-2333-4414-8262-a7a05e8193c9', '45e82eee-9428-4b40-8568-bc4af17c48b1', 5, 0, '2024-06-22', '未定', 'finished', 'd0efd9f2-bca5-47dd-a70f-7b60f814a1dc'
WHERE NOT EXISTS (
...
INSERT INTO matches (home_team_id, away_team_id, home_score, away_score, match_date, venue, status, season_id)
VALUES ('7b4c8e6b-2333-4414-8262-a7a05e8193c9', '7d2c5a9d-3c44-4210-9599-b98dfa8bd626', 1, 0, '2024-10-01', '未定', 'finished', 'd0efd9f2-bca5-47dd-a70f-7b60f814a1dc');
...
INSERT INTO matches (home_team_id, away_team_id, home_score, away_score, match_date, venue, status, season_id)
SELECT '90e69fe7-38b9-4bf7-afaa-e729ef95decc', '2e0cb14e-5a4f-440d-a341-3c9e6112355d', 4, 0, '2024-11-16', '未定', 'finished', 'd0efd9f2-bca5-47dd-a70f-7b60f814a1dc'
WHERE NOT EXISTS (
  SELECT 1 FROM matches
  WHERE home_team_id = '90e69fe7-38b9-4bf7-afaa-e729ef95decc'
  AND away_team_id = '2e0cb14e-5a4f-440d-a341-3c9e6112355d'
